...
class AdminRejectedUsersListPage extends StatelessWidget {
  AdminRejectedUsersListPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Obx(() {
        ...
        if (getxController.rejectedUsersList.isEmpty) {
          return Center(
            child: Text(
        ...
        return ListView.separated(
          ...
          itemCount: getxController.rejectedUsersList.length,
          separatorBuilder: (_, __) => const SizedBox(height: 10),
          itemBuilder: (context, index) {
            final user = getxController.rejectedUsersList[index];

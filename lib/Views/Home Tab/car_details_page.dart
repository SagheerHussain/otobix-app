...
class CarDetailsPage extends StatelessWidget {
              ...
              children: [
                SingleChildScrollView(
                  padding: const EdgeInsets.only(
                    bottom: 120,
                  ), // Enough space for bottom button
                ...
                Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: _buildBidButton(getxController),
                ),
              ],
            );
          },
    ...
    return Positioned(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Icon(Icons.arrow_back_ios_new, color: AppColors.white, size: 12),
  ...
  Widget _buildMainDetails({required CarModel car}) {
    return Column(
      children: [
        ...
        Row(
          children: [
            Icon(Icons.location_on, color: AppColors.gray, size: 12),
  ...
  Widget _buildIconAndTextDetails({required CarModel car}) {
    return Row(
      ...
      children: [
        Column(
          children: [
            Icon(Icons.speed, color: AppColors.gray, size: 20),
            Text(
        ...
        Column(
          children: [
            Icon(Icons.local_gas_station, color: AppColors.gray, size: 20),
            Text(car.fuelType, style: const TextStyle(fontSize: 10)),
          ],
        ),
        Column(
          children: [
            Icon(Icons.settings, color: AppColors.gray, size: 20),
            Text('Automatic', style: const TextStyle(fontSize: 10)),
          ],
        ),
        Column(
          children: [
            Icon(Icons.color_lens, color: AppColors.gray, size: 20),
            Text('White', style: const TextStyle(fontSize: 10)),
          ],
        ),
        Column(
          children: [
            Icon(Icons.event, color: AppColors.gray, size: 20),
            Text('Dec 2025', style: const TextStyle(fontSize: 10)),
          ],
        ),
      ],
    );
  ...
  Widget _buildDetailRowForOtherDetails(String title, String value) {
    return Column(
      children: [
        ...
        Divider(color: AppColors.gray.withValues(alpha: .2)),
      ],
    );
  }
  ...
  Widget _buildBidButton(CarDetailsController getxController) {
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(
              top: BorderSide(color: AppColors.green.withValues(alpha: .5)),
              left: BorderSide(color: AppColors.green.withValues(alpha: .5)),
              right: BorderSide(color: AppColors.green.withValues(alpha: .5)),
            ),
            boxShadow: [
              BoxShadow(
                color: AppColors.black.withValues(alpha: .2),

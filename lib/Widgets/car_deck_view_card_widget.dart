...
class CarDeckViewCardWidget extends StatelessWidget {
  final CarsListModel car;
  // final Function(CarsListModel car) toggleFavorite;
  final Widget footer;
  final VoidCallback onCarTap;
  final bool showAddToWishlistIcon;
  const CarDeckViewCardWidget({
    super.key,
    required this.car,
  ...
  Widget build(BuildContext context) {
    ...
    return _buildCarCard(homeController);
  }

  Widget _buildCarCard(HomeController homeController) {
              ...
              children: [
                ...
                if (showAddToWishlistIcon)
                  Positioned(
                    ...
                    right: 10,
                    child: Obx(() {
                      final isThisCarFav = homeController.wishlistCarsIds
                          .contains(car.id);
                      return InkWell(
                        onTap: () => homeController.toggleFavorite(car),

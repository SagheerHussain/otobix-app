...
import 'package:otobix/admin/controller/admin_upload_policies_controller.dart';

class AdminUploadPoliciesPage extends StatelessWidget {
  AdminUploadPoliciesPage({super.key}) {
    Get.put(AdminUploadPoliciesController(), permanent: true);
  }

  @override
  Widget build(BuildContext context) {
    final getxController = Get.find<AdminUploadPoliciesController>();
...
class _ResponseCard extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final uploadTermsController = Get.find<AdminUploadPoliciesController>();

...
import 'package:otobix/admin/controller/admin_upload_user_guide_controller.dart';

class AdminUploadUserGuidePage extends StatelessWidget {
  AdminUploadUserGuidePage({super.key}) {
    Get.put(AdminUploadUserGuideController(), permanent: true);
  }

  @override
  Widget build(BuildContext context) {
    final getxController = Get.find<AdminUploadUserGuideController>();
...
class _ResponseCard extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final uploadTermsController = Get.find<AdminUploadUserGuideController>();
